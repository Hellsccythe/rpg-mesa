...
<section class="pagina">
  ...
  <div class="nota">
    <p><code>receitas.pericia_id</code> está no banco desde a migration 077, reservado e <strong>nulo em
    todas as 28 linhas</strong>. Cozinha é o primeiro caso a usá-lo — foi exatamente para isto que a coluna
    foi criada.</p>
  </div>
